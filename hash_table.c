...
#define CAPACITY 10000 // Size of the HashTable.
...
{
    // Allocates memory for a LinkedList and return the pointer.
...
int main(void)
{
    ...
    for(int i=0;i < CAPACITY; i++) {
        ...
        ht_insert(ht, i_str, str);
    }

    ht_insert(ht, "1", "First address");
    ht_insert(ht, (char *)"2", (char *)"Secondd address");
